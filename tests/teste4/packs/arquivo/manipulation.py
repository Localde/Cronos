...
def modeloMonofasicoParaEstudo(arq):
     try:
          a = open(arq, 'at')
     except Exception:
          ...
          try:
               ...
               dormir = str(input('Que horas vai dormir?'))
...
def modeloBifasicoParaEstudo(arq):
     try:
          a = open(arq, 'at')
     except Exception:
          print('Houve um ERRO na hora de escrever os dados!')
...
def modeloEverymanParaEstudo(arq):
     try:
          a = open(arq, 'at')
     except Exception:
          print('Houve um ERRO na hora de escrever os dados!')
...
def modeloDymaxionParaEstudo(arq):
     try:
          a = open(arq, 'at')
     except Exception:
          print('Houve um ERRO na hora de escrever os dados!')
...
def modeloUbermanParaEstudo(arq):
     try:
          a = open(arq, 'at')
     except Exception:
          print('Houve um ERRO na hora de escrever os dados!')
