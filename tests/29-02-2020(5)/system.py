...
from packs.cronosestudo import estudo, ed_fisica, organizacao, alimentacao
...
arquivo_alimentacao = 'cronos/cronograma_de_alimentacao/cronograma_alimentacao.txt'
...
while True:
        ...
        if codigo == 'x' and len(codigo) == 1:
                ...
                if codigo[1] == 'new' and len(codigo[1]) == 3:
                        ...
                        elif codigo[2] == 'al' and len(codigo[2]) == 2: #Cronograma de Organização e Limpeza
                                if not manipulation.verificaSeExiste(arquivo_alimentacao):
                                        manipulation.criarDoc(arquivo_alimentacao)
                                        alimentacao.alimentacao(arquivo_alimentacao)
